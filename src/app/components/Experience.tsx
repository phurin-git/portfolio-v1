    ...
    return (
        <a className="py-2.5 grid grid-cols-3 group hover:text-focus" href={props.item.website} target="_blank" rel="noopener noreferrer">
            ...
            <div className="grid-cols-subgrid col-span-2 flex-col">
                <div className="max-w-xs leading-normal font-medium flex flex-row content-center items-center">
                ...
                <div className="my-2 max-w-xs leading-normal transition-all motion-reduce:transition-none">
