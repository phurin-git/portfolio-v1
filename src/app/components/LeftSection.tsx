    ...
    return (
      <div className="mb-10 lg:min-h-screen lg:sticky lg:top-0 lg:flex lg:flex-col lg:justify-between lg:max-h-screen  lg:py-24 lg:mb-0">
        ...
        <div className="flex flex-row mt-10 lg:mt-0">
          <a className="mr-5 transition-all hover:text-hightlight motion-reduce:transition-none" href={card.myEmail}>
          ...
          <a className="mr-5 transition-all hover:text-hightlight motion-reduce:transition-none" href={card.myGithub}>
          ...
          <a className="mr-5 transition-all hover:text-hightlight motion-reduce:transition-none" href={card.myLinkedin}>
          ...
          <a className="mr-5 transition-all hover:text-hightlight motion-reduce:transition-none" href={card.myFacebook}>
            <svg className="size-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
              <path d="M512 256C512 114.6 397.4 0 256 0S0 114.6 0 256C0 376 82.7 476.8 194.2 504.5V334.2H141.4V256h52.8V222.3c0-87.1 39.4-127.5 125-127.5c16.2 0 44.2 3.2 55.7 6.4V172c-6-.6-16.5-1-29.6-1c-42 0-58.2 15.9-58.2 57.2V256h83.6l-14.4 78.2H287V510.1C413.8 494.8 512 386.9 512 256h0z"/>
            </svg>
          </a>
          <a className="transition-all hover:text-hightlight motion-reduce:transition-none" href={card.myInstagram}>
            <svg className="size-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor">
